...
export class ScholarshipDetailsListComponent implements OnInit {
  ...
  studentId:number=JSON.parse(localStorage.getItem('applicationDetails')).personalId;
  ...
  fetchStatus(){
   ...
   onApproval(){
    ...
    this.http.post('http://localhost:8585/instituteUpdatesStudentStatus',

      {
         instituteApprovalStatus:true,
